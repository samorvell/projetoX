...
public class FuncionarioServiceImpl implements FuncionarioService {
	...
	@Override
	public Page<Funcionario> buscarFuncionarioPorEmpresaId(Long companyId, PageRequest pageRequest) {
		log.info("Buscando funcionário pelo ID {}", companyId);
		return this.funcionarioRepository.findAllByEmpresaId(companyId, pageRequest);
	}	
}
